...
function changeStyle(sheet) {
	...
	if(sheet == "stylesheet.css") {
		document.getElementById("icon").setAttribute("href", "../images/skullmain.ico");
		document.getElementById("myPic").setAttribute("src", "../images/me3.jpg");
		...
		document.getElementById("icon").setAttribute("href", "../images/skullfuture.ico");
		document.getElementById("myPic").setAttribute("src", "../images/steampunkme3.png");
		document.getElementById("content").classList.add("screen");
		document.getElementById("work").style.background = "url('../images/futureneoncity.jpg') center no-repeat";
		document.getElementById("work").style.backgroundSize = "cover";
		document.getElementById("about").style.background = "url('../images/sci-fi-neon.jpg') center no-repeat";
		...
		document.getElementById("myPic").setAttribute("src", "../images/me2.jpg");
	}
}
